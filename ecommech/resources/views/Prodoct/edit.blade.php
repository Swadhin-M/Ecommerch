          ...
          <div class="card-body">
            ...
            <form action="{{ $url }}" method="post" enctype="multipart/form-data">
              ...
              <div class="row mb-3">
                ...
                <div class="col-sm-10">
                  <input type="text" class="form-control" name="name" value="{{ $prodoct->name }}">
                </div>
              </div>
              ...
              <div class="row mb-3">
                ...
                <div class="col-sm-10">
                  <input type="number" class="form-control" name="price" value="{{ $prodoct->price }}">
                </div>
              </div>
              ...
              <div class="row mb-3">
                ...
                <div class="col-sm-10">
                  <textarea class="form-control" style="height: 100px" name="discription">{{ $prodoct->discription }}</textarea>
                </div>
              </div>
